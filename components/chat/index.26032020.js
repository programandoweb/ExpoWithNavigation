...
class App extends Component {
  ...
  chat = () =>{
    return    <View style={Styles.itemListFullWidth}>
                ...
                {
                  (this.state.mensajes.length>0)?this.state.mensajes.map((v,k)=>{return <ItemList yo={this.context} key={k} data={v}/>}):<ItemVacio count={this.state.mensajes} message="Aún no hay mensajes"/>
                }
